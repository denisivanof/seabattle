...
import {getDefaultShips, isNormalPosition, randomize} from '../utility/index'
...
export const editorSlice = createSlice({
    ...
    reducers: {
        ...
        reset(state) {state.ships = getDefaultShips()},
...
export const {place, dock, random, reset, rotate, setShips} = editorSlice.actions
